    ...
    if _embedding is None:
        ...
        if settings.GEMINI_API_KEY:
            try:
                ...
                logger.info("✅ Gemini embeddings initialized for Pinecone storage")
                return _embedding
        ...
        logger.warning("Neither GEMINI_API_KEY nor OPENAI_API_KEY found. Pinecone video storage will be disabled.")
        return None
    return _embedding
